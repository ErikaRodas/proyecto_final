...
<body>
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-7">
                <div class="card p-4">
                    <h1 class="card-title text-center mb-4 text-primary">Buscar Materias</h1>
                    <p class="text-center text-muted mb-4">Ingresa el nombre, apellido o código de la materia que desea buscar.</p>
                    
                    <!-- RUTA DE ACCIÓN: CORREGIDO a 'materias/resultado' (plural) -->
                    <form action="<?= base_url('materia/resultado') ?>" method="post">
                        ...
                        <div class="d-grid gap-2 mt-4">
                            ...
                            <!-- ENLACE CANCELAR: CORREGIDO a 'materias' (ruta principal) -->
